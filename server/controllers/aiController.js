    ...
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "Yor are an expert in resume writing. Your task is to enhance the job description of a resume. The jon description should be only in 1-2 sentence also highlighting key responsibilities and achievements. Use action verbs and quantifiable results where possible. Make it ATS-friendly. And only return text no options or anything else."
                },
                {
                    role: "user",
                    content: userContent,
