...
const ProjectForm = ({ data, onChange, focusedField, setFocusedField }) => {
                    ...
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='grid gap-3'>
                            ...
                            <input
                                ...
                                onFocus={() => setFocusedField && setFocusedField(`project-${index}-name`)}
                                onBlur={() => {
                                    setTimeout(() => {
                            ...
                            <input
                                ...
                                onFocus={() => setFocusedField && setFocusedField(`project-${index}-type`)}
                                onBlur={() => {
                                    setTimeout(() => {
                                        if (setFocusedField && focusedField === 'professional_summary') {
                                            if (!listeningRef?.current) setFocusedField(null);
                            ...
                            <textarea
                                ...
                                onFocus={() => setFocusedField && setFocusedField(`project-${index}-description`)}
                                onBlur={() => {
                                    setTimeout(() => {
                                        if (setFocusedField && focusedField === 'professional_summary') {
                                            if (!listeningRef?.current) setFocusedField(null);
